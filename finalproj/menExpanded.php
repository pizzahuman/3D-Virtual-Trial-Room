                    ...
                    <div class="Column">
                        ...
                        <div class="left-column">
                            ...
                            <div class="container3">
                                ...
                                <div class="row">
                                    <div class="column">
                                        <img class="demo cursor" src="pic/SD_03_T16_6810M_F0_X_EC_1.webp"
                                            style="width:100%; height: 35%;" onclick="currentSlide(1)">
                                    </div>
                                    <div class="column">
                                        <img class="demo cursor" src="pic\SD_03_T16_6810M_F0_X_EC_90.jpg"
                        ...
                        <div class="right-column">
                            ...
                            <div>
                                ...
                                <div class="panel">
                                    <p>
                                        Style: <?php echo $fetch_product['style']; ?></br>
                                        Composition: <?php echo $fetch_product['composition']; ?></br>
                                        More Details: <?php echo $fetch_product['address_detail']; ?></br>
                                        Generic Type: <?php echo $fetch_product['generic_type']; ?></br>
                                        Pack Size: <?php echo $fetch_product['pack_size']; ?></br>
                                        Net Quantity: NA<br/>
